...
If you're interested in contributing to this project, feel free to submit a pull request or open an issue on the [GitHub repository](https://github.com/SkyBotsDeveloper/QuizBot).
...
We welcome contributions! Please check out our [contribution guidelines](https://github.com/SkyBotsDeveloper/QuizBot/blob/main/CONTRIBUTING.md) for more information on how to get started.

---

## 📄 License

This project is licensed under the MIT License - see the [LICENSE](https://github.com/SkyBotsDeveloper/QuizBot/blob/main/LICENSE) file for details.
