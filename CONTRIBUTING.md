...
- First, fork the [QuizBot GitHub repository](https://github.com/SkyBotsDeveloper/QuizBot) to your own GitHub account.
...
By contributing, you agree that your contributions will be licensed under the project's [MIT License](https://github.com/SkyBotsDeveloper/QuizBot/blob/main/LICENSE).
...
- Reach out to the maintainers via the [GitHub Issues](https://github.com/SkyBotsDeveloper/QuizBot/issues) page.
